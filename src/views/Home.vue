        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde el enfoque del Derecho Procesal, la jurisdicción y la competencia representan fundamentos esenciales para la organización del sistema judicial y la protección del debido proceso. En esta unidad, el estudiante profundizará en la noción de jurisdicción como función pública del Estado, comprendiendo su ejercicio exclusivo para la resolución de conflictos, mediante decisiones con fuerza legal.
              
              p #[b ¡Prepárese para conocer los pilares que estructuran el proceso judicial colombiano y fortalecer su criterio jurídico con seguridad y rigor técnico!]
